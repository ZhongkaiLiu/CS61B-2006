...
class Date {
  ...
  // return days from the date 1/1/1
  private int daysFromBegin() {
    int days = day;
  ...
  public static boolean isValidDate(int month, int day, int year) {
    if((year<1)||(day<1)||(day>daysInMonth(month,year))) {
      return false;
    }else{
      return true;
    }
  ...
  public int difference(Date d) {
    return this.daysFromBegin() - d.daysFromBegin();
  }
