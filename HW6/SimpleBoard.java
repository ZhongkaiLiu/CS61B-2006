...
public class SimpleBoard {
  ...
  public void setElementAt(int x, int y, int value) throws ArrayIndexOutOfBoundsException {
    if(x<0||x>7||y<0||y>7) {
  ...
  public int elementAt(int x, int y) throws ArrayIndexOutOfBoundsException {
    if(x<0||x>7||y<0||y>7) {
      throw new ArrayIndexOutOfBoundsException();
    }
    return grid[x][y];
