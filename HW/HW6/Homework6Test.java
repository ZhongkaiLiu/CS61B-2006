...
public class Homework6Test {
  ...
  public static void main(String[] args) {
    ...
    // test hash table find() and remove()
    SimpleBoard bd = randomBoard();
    HashTableChained tb = new HashTableChained(numBoards);

    System.out.println();
    tb.insert(bd, new Integer(10));
    System.out.println(tb.find(bd).value());
    System.out.println(tb.remove(bd));
    System.out.println(tb.find(bd));
